...
const AnnounceCard = ({ propertyTitle, housePicture, showPropertyDetails, profilePicture, address, author, budget, propertyType}) => {
    ...
    return (
        ...
        onClick={showPropertyDetails}>
            ...
            <div className="mb-4 p-2">
                ...
                <div className="mb-2">
                    <p className="text-gray-600 font-bold text-sm">{propertyTitle}</p>
                </div>
                <div className="mb-4 flex flex-row justify-between">
                    <p className="text-gray-600 text-xs">{propertyType}</p>
                    <p className="text-gray-600 text-xs ml-2">2 rooms</p>
                </div>
                <div className="mb-2">
