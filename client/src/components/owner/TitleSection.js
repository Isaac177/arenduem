...
const TitleSection = ({ firstProperty, propertyDetails }) => {
    return (
        <div className="flex my-8 flex-row justify-between border-l-8 pb-4 border-aqua-500 bg-white rounded-lg p-4">
            <div className='row flex flex-col gap-4'>
                ...
                <h1 className="text-4xl font-bold text-primary-700">{propertyDetails && propertyDetails.title}</h1>
            ...
            <div className='row flex gap-4 flex-col'>
                ...
                <h1 className="text-4xl font-bold text-aqua-500">{firstProperty && firstProperty.Price.pricePerMonth} kzt<span className="text-4xl text-gray-500">/month</span></h1>
            </div>
        </div>
    );
};
