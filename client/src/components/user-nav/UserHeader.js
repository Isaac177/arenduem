        ...
        <header className="backdrop-blur-lg text-white bg-primary-800 bg-opacity-50 py-5">
            <div className="container mx-auto flex flex-wrap items-center">
                <div className="w-full lg:w-auto lg:flex-grow lg:flex lg:items-center">
                    <h1 className="text-4xl lg:text-5xl font-bold text-center text-white tracking-tight cursor-pointer relative">
                ...
                <div className="relative mr-4">
                    <button className="inline-flex items-center text-sm px-4 py-2 leading-none rounded-full text-white border-white hover:text-primary-900 hover:bg-white mt-4 lg:mt-0">
                    ...
                    {showMenu && (
                        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10">
                            <NavLink
                                exact={true}
                                to="/user/profile"
                                className="block w-full px-4 py-2 text-gray-800 hover:bg-primary-700 hover:text-white"
                            >
                            ...
                            <button
                                ...
                                className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-primary-700 hover:text-white"
                            >
