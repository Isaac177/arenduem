...
const Testimony = () => {
    ...
    const testimonyStyle = clsx({
        'mt-[-82px]': isSmallViewport,
        'sm:mt-[-280px]': !isSmallViewport
    });
    ...
    return (
        <Element className="relative">
            ...
            <div className={`flex flex-wrap justify-around items-center p-4 py-24 bg-primary-900 ${testimonyStyle}`}>
                 <ScrollAnimation
